<script lang="ts">
  ...
  import findInTabContent from "./find-in-tab-content";
  import { writable } from "svelte/store";
  import { defaultSearchEngine, searchEngines } from "$lib/config/config";
  ...
  let selectedSearchEngine = defaultSearchEngine;
  ...
  function searchSelected() {
    var baseURL = searchEngines[selectedSearchEngine];
...
<div class="container mx-auto p-2 max-w-sm">
  ...
  <div class="flex space-x-1 mb-2">
    <div class="relative inline-block text-left flex-grow search-dropdown">
      <Button 
        type="button" 
        class="w-full bg-slate-500 hover:bg-slate-500 inline-flex items-center justify-between"
      >
    ...
    <!-- <Button on:click={toggleFullScreen} class="flex-shrink-0 ml-1">
